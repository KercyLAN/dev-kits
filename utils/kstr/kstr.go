...
// RemoveLast 返回str中去除最后一个字符后的字符串
...
// RemoveFirst 返回str中去除第一个字符后的字符串
...
// Distinct 返回str中由多个连续字符char转换为一个字符后的字符串
...
// IsUpperPrefix 返回str是否为大写字母开头的字符串
func IsUpperPrefix(str string) bool {
	return ((str)[0] >= 65) && ((str)[0] <= 90)
}

// IsLowerPrefix 返回str是否为小写字母开头的字符串
...
// UpperFirst 返回将str首字符转换为大写后的字符串
...
// LowerFirst 返回将str首字符转换为小写后的字符串
